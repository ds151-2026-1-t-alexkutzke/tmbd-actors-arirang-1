...
export default function MovieDetailsScreen() {
  ...
  useEffect(() => {
    ...
    fetchMovieDetails(); // O hook é re-executado caso o ID mude
  }, [id]);
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: '#FFFFFF', fontSize: 18, fontWeight: 'bold', marginTop: 16, marginBottom: 8 },
  overview: { color: '#D1D5DB', fontSize: 16, lineHeight: 24, marginBottom: 10 },
  errorText: { color: '#FFFFFF', fontSize: 18 },
  castCard: { marginRight: 16, width: 100 },
  castImage: { width: 100, height: 120, borderRadius: 8 },
  castName: { color: '#FFF', fontSize: 12, fontWeight: 'bold', marginTop: 4 },
  castCharacter: { color: '#9CA3AF', fontSize: 10 },
});